...
//	$scope.aboutAnswers=answers;
	...
	var toSend={group:localData,prediction:predictionAbout,answer:declareAnswer.name,outcome:declareOutcome};
	...
	$http.get('/predictData/'+reqPredictionString)
		...
		if ($scope.userName===$scope.graphMeta.author||$scope.userName==="admin") {
		   $scope.deleteShow=1;
		}
